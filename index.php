...
<head>
    ...
    <style>
        ...
        .key.zero {
            width: 20%; /* Largura do botão zero ajustada */
            height: 50px;
            
        }
        .key.registrar {
            width: 20%; /* Largura do botão Registrar ajustada */
            height: 50px;
...
<body style="display: flex;justify-content: center; align-items: center; font-size: 230%;">
        ...
        <div class="borda">
            ...
            <form action="src/register/registrar_ponto.php" method="post">
                ...
                <br><br>
                <input id="num" style="height: 40px; width: 90%;" type="password" minlength="4" maxlength="4" name="pin" placeholder="Informe o pin" required>
                ...
                <div class="keypad">
                    ...
                    <button class="key registrar" style="background-color: green; color: white;" type="submit" id="submit-btn" disabled><b>✅</b></button><br> 
