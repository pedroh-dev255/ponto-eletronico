            ...
            <form action="" method="get">
                <table>
                    <tr>
                        ...
                        <td>
                            <label class="switch">
                                <input name="zap_fun" type="checkbox" <?php if ($row['zap_fun'] == 'on') {
                                    echo "checked";
                                } ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="switch">
                                <input name="zap_dir" id="zapDirSwitch" type="checkbox" <?php if ($row['zap_dir'] == 'on') {
                                    echo "checked";
                                } ?>>
                                <span class="slider round"></span>
                            </label>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="tel" name="fone" id="foneInput" maxlength="15" onkeyup="handlePhone(event)"
                                value="<?php echo $row['fone_dir'] ?>">
                        </td>
                    </tr>
                    <tr>
                    <tr>
                        ...
                        <td>
                            <label class="switch">
                                <input name="bh" type="checkbox" <?php if ($row['bh'] == 'on') {
                                    echo "checked";
                                } ?>>
                                <span class="slider round"></span>
                            </label>
