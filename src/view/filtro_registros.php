...
<body>
    ...
    <form action="./filtro_registros.php" method="get">
        ...
        <select name="mes" required>
            <option></option>
            <option value="01" <?php if (isset($_GET['mes']) && $_GET['mes'] == '01') {
                echo "selected";
            } ?>>Janeiro</option>
            <option value="02" <?php if (isset($_GET['mes']) && $_GET['mes'] == '02') {
                echo "selected";
            } ?>>Fevereiro
            </option>
            <option value="03" <?php if (isset($_GET['mes']) && $_GET['mes'] == '03') {
                echo "selected";
            } ?>>Março</option>
            <option value="04" <?php if (isset($_GET['mes']) && $_GET['mes'] == '04') {
                echo "selected";
            } ?>>Abril</option>
            <option value="05" <?php if (isset($_GET['mes']) && $_GET['mes'] == '05') {
                echo "selected";
            } ?>>Maio</option>
            <option value="06" <?php if (isset($_GET['mes']) && $_GET['mes'] == '06') {
                echo "selected";
            } ?>>Junho</option>
            <option value="07" <?php if (isset($_GET['mes']) && $_GET['mes'] == '07') {
                echo "selected";
            } ?>>Julho</option>
            <option value="08" <?php if (isset($_GET['mes']) && $_GET['mes'] == '08') {
                echo "selected";
            } ?>>Agosto</option>
            <option value="09" <?php if (isset($_GET['mes']) && $_GET['mes'] == '09') {
                echo "selected";
            } ?>>Setembro
            </option>
            <option value="10" <?php if (isset($_GET['mes']) && $_GET['mes'] == '10') {
                echo "selected";
            } ?>>Outubro</option>
            <option value="11" <?php if (isset($_GET['mes']) && $_GET['mes'] == '11') {
                echo "selected";
            } ?>>Novembro
            </option>
            <option value="12" <?php if (isset($_GET['mes']) && $_GET['mes'] == '12') {
                echo "selected";
            } ?>>Dezembro
            </option>
        </select>
    ...
    <script>
        function imprimir() {
            ...
            var janela = window.open('<?php if (isset($_GET['ano'])) {
                echo "folha-de-ponto.php?id=" . $_GET['fun'] . "&mes=" . $_GET['mes'] . "&ano=" . $_GET['ano'];
            } ?>', '_blank');
        }
    </script>
    <table>
